...
""" Method: Invocation status tracking """
...
class Method:  # pylint: disable=E1101,R0903,W0201
    ...
    def invocation_task_change(self, event, data):
        ...
        #
        toolkit_name = task_meta.get("toolkit_name", "ImageGen")
        tool_name = task_meta.get("tool_name", "generate_image")
        #
        with self.state_lock:
    ...
    def invocation_thinking(self, message):
        """ Store custom event for progress updates """
        try:
