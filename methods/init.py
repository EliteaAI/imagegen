...
class Method:  # pylint: disable=E1101,R0903,W0201
    ...
    def init(self):
        """ Init """
        log.info("Initializing ImageGen plugin TaskNode")
        #
        ...
        self.invocation_task_node = arbiter.TaskNode(
            ...
            pool="invocation",
            task_limit=None,
            ident_prefix="imagegen_invocation_",
        ...
        #
        log.info("ImageGen plugin TaskNode initialized successfully")

    @web.deinit()
    def deinit(self):
        """ De-Init """
        log.info("Deinitializing ImageGen plugin TaskNode")
        #
        ...
        #
        log.info("ImageGen plugin TaskNode deinitialized")
